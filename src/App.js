...
const Component = ({
  ...
  const Delete = {
    ...
    render(moveable: MoveableManagerInterface<any, any>, React: Renderer) {
        ...
        // use css for able
        const DeleteViewer = moveable.useCSS("div", `
        {
            position: absolute;
            left: 0px;
            top: 0px;
        ...
        return <DeleteViewer key="delete-viewer" className={"moveable-delete"} style={{
            transform: `translate(${pos2[0]}px, ${pos2[1]}px) rotate(${rect.rotation}deg) translate(10px)`,
        }}>
            <button className="moveable-button" onClick={() => deleteMoveable(id)}>x</button>
        </DeleteViewer>;
    }
  } 
